...
if {[info exists ::env(RESULTS_DIR)]} {
  set svg_file "$::env(RESULTS_DIR)/aes_fixed_dissection_lp_fill.svg"
  set density_report "$::env(RESULTS_DIR)/aes_fixed_dissection_lp_fill_density.json"
} else {
  set svg_file "$script_dir/aes_fixed_dissection_lp_fill.svg"
  set density_report "$script_dir/aes_fixed_dissection_lp_fill_density.json"
}
